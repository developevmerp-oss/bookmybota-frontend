...
export default function ArtistClaimEventsPage() {
  ...
  if (!businessId) {
    return <p className="text-zinc-400 p-6">Sign in as an artist partner to claim events.</p>;
  }

  return (
    <div className="max-w-3xl mx-auto space-y-6">
      <div>
        <h1 className="text-2xl font-bold text-white">Claim events featuring you</h1>
